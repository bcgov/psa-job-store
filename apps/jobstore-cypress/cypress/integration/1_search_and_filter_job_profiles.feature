Feature: Search and Filter Job Profiles
    ...
    Scenario: Combine Job Family and Classification filters together
        ...
        And the user selects "Communications Officer R30" from the classification filter dropdown
        Then only job profiles classified under "Budgeting" job family and "Communications Officer R30" classification should be displayed
