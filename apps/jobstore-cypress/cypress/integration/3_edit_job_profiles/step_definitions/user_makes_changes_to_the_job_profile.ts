...
When('the user changes the job title to "Project Manager"', () => {
  ...
  cy.get('[data-testid="job-title-input"]').type('Project Manager');
});

When('the user changes program overview to "Program overview updated"', () => {
  cy.get('[data-testid="program-overview-input"]').clear();
  cy.get('[data-testid="program-overview-input"]').type('Program overview updated');
});

When('the user changes job overview to "Overview updated"', () => {
  cy.get('[data-testid="job-overview-input"]').clear();
  cy.get('[data-testid="job-overview-input"]').type('Overview updated');
});
